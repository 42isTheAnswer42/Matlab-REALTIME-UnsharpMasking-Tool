function [theRGB2XYZMatrix, theXYZ_WP, theXYZ_BP, theRGSpectrum, theRSpectrum] = analyzePrimaries( theRGBData, theSpectralData, theProfileDir, theFBlackSubtraction)
